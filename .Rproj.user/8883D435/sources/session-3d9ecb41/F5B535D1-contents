...
// minimizR
Rcpp::List minimizR(Rcpp::NumericVector par, Rcpp::Function fn, Rcpp::Function gr, Rcpp::Nullable<Rcpp::List> control);
RcppExport SEXP _minimizR_minimizR(SEXP parSEXP, SEXP fnSEXP, SEXP grSEXP, SEXP controlSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(minimizR(par, fn, gr, control));
